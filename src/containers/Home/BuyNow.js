...
const BuyNow = () => {
  ...
  return (
    <React.Fragment>
      <Container className="detail-lisiting">
        <Row className="mt-4 pt-4 mb-4 homepagesponsored-headlines my-5">
          <Col xs={12} className="mb-4 mb-lg-0 pt-4">
                    ...
                    return (
                      <ListGroup.Item key={domain + index}>
                        <div className="d-flex justify-content-between ">
                          <span>{domain.domain_obj.domain_name}</span>
                          <Button
                            onClick={(e) =>
